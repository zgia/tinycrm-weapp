...
VantComponent({
  props: Object.assign(Object.assign({ disabled: Boolean,
    multiple: Boolean,
    uploadText: String,
  ...
  methods: {
    ...
    onBeforeRead(file) {
      ...
      if (useBeforeRead) {
        res = new Promise((resolve, reject) => {
          this.$emit('beforeread', Object.assign(Object.assign({ file }, this.getDetail()), { callback: (ok) => {
            ok ? resolve() : reject()
          } }))
        })
      }
    ...
    onPreviewImage(event) {
      ...
      this.$emit('clickpreview', Object.assign({ url: item.url || item.path }, this.getDetail(index)))
